...
class App extends Component {
  ...
  handleSearch() {
    axios.get(`https://rest.bandsintown.com/artists/${this.state.query}?app_id=1234`)
      .then((res) => {
        if (res.data !== null && res.data !== undefined) {
          if (res.data.name === '') {
            ...
            if (res.data.upcoming_event_count > 0) {
              axios.get(`https://rest.bandsintown.com/artists/${this.state.query}/events?app_id=1234`)
                .then((eventRes) => {
